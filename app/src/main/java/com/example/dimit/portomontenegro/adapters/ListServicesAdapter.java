...
public class ListServicesAdapter  extends ArrayAdapter<ZFacilities> {

    Typeface font;
    Dialog dialog = null;
    Dialog webView = null;

    public ListServicesAdapter(Context context, int resource, List<ZFacilities> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        int RLayout = R.layout.services_item;
